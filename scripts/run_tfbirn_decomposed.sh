...
python main.py --data_config configs/data/fbirn_subject.json --model_config configs/models/decomposed_vae.json --run_config configs/runs/tvae.json -hn $SLURM_ARRAY_TASK_ID
