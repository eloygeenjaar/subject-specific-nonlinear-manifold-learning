...
python main.py --data_config configs/data/sherlock_ev_ssl.json --model_config configs/models/decomposed_ssl.json --run_config configs/runs/ssl.json -hn $SLURM_ARRAY_TASK_ID
