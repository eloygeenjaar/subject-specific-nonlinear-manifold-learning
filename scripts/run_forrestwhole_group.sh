...
python main.py --data_config configs/data/forrest_full.json --model_config configs/models/group_autoencoder.json --run_config configs/runs/autoencoder.json -hn $SLURM_ARRAY_TASK_ID
