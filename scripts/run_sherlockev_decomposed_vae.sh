...
python main.py --data_config configs/data/sherlock_ev.json --model_config configs/models/decomposed_vae.json --run_config configs/runs/vae.json -hn $SLURM_ARRAY_TASK_ID
