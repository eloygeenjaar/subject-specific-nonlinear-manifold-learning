...
python main.py --data_config configs/data/subject_moons.json --model_config configs/models/decomposed_classifier.json --run_config configs/runs/classification.json -hn $SLURM_ARRAY_TASK_ID
