...
python main.py --data_config configs/data/sherlock_ev.json --model_config configs/models/subject_autoencoder.json --run_config configs/runs/autoencoder.json -hn $SLURM_ARRAY_TASK_ID
sleep 30s
